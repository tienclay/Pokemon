...
impl Block {
    pub fn new(color: String, eye_num: String, nose_num: String, mouth_num: String,) -> Self {
        Self {
            color, eye_num, nose_num, mouth_num,
        }
    }
}
...
impl App {
    ...
    fn init(&mut self) {
        let init_block = Block {
            ...
            eye_num: String::from("2"),
            nose_num: String::from("1"),
            mouth_num: String::from("1"),
        };
        self.blocks.insert(String::from("Clay"), init_block);
    }
    fn try_add_block(&mut self, name:String, block: Block) {
        // Kiểm tra xem name đã tồn tại trong HashMap chưa
